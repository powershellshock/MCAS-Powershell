...
$ReportsList = @{
    ...
    'Browser Use'                            = 'browser_usage_entities'
	...
	'Inactive Accounts'                      = 'zombie_users_entities'
	#'Privileged Users'                       = 'admins'
	'Privileged Users'                       = 'admins_entities'
    #'Salesforce Special Privileged Accounts' = 'sf_permissions'
    'Salesforce Special Privileged Accounts' = 'sf_permissions_entities'
    #'User Logon'                             = 'logins_rate'
	#'Data Sharing Overview'                  = 'files_summary'
    'Data Sharing Overview'                  = 'files_summary_entities'
    #'File Extensions'                        = 'file_extensions'
	#'Orphan Files'                           = 'orphan_files'
    #'Outbound Sharing by Domain'             = 'external_domains'
    'Outbound Sharing by Domain'             = 'external_domains_entities'
	#'Owners of Shared Files'                 = 'shared_files_owners'
    'Owners of Shared Files'                 = 'shared_files_owners_entities'
